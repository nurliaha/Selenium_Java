...
public class Case2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<String> itemss = Arrays.asList("Banana","Beetroot","Almonds");
//		System.out.println(itemss.get(0));
		for(int i=0; i<itemss.size(); i++) {
			driver.findElement(By.xpath("//*[@id=\"root\"]/div/header/div/div[2]/form/input")).sendKeys(itemss.get(i));	
			Thread.sleep(1000);
			...
			driver.findElement(By.xpath("//*[@id=\"root\"]/div/header/div/div[2]/form/input")).clear();
		}
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div/div/div[3]/button")).click();
